// models/product_repository.dart
...
class ProductRepository {
  ...
  void _initializeProducts() {
    final Category mensCategory = Category(title: 'Men', selections: [
      'Shirts',
      'Jeans',
      'Shorts',
    ]);

    final Category womensCategory = Category(title: 'Women', selections: [
      'Shirts',
      'Jeans',
    ]);

    final Category petsCategory = Category(title: 'Pets', selections: [
      'Toys',
      'Treats',
    ]);
